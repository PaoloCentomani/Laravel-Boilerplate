<div class="p-6 sm:px-20 bg-white border-b border-gray-200 cursor-default">
...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 cursor-default">
    <div class="p-6">
